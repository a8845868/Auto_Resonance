...
def _buy() -> list[dict]:
    return [_ocr("交易品", 200, 100), _ocr("预计买入", 900, 500), _ocr("全部买入", 900, 600), _ocr("买入总价(含税)", 900, 550), _ocr("载货量", 600, 650)]


def _sell() -> list[dict]:
    return [_ocr("交易品", 200, 100), _ocr("预计卖出", 900, 500), _ocr("全部卖出", 900, 600), _ocr("卖出总价(含税)", 900, 550), _ocr("载货量", 600, 650)]
